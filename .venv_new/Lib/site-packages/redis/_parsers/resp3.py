...
class _RESP3Parser(_RESPBase):
    ...
    def _read_response(self, disable_decoding=False, push_request=False):
        ...
        # push response
            ...
            response = self.handle_push_response(response, disable_decoding, push_request)
            if not push_request:
...
class _AsyncRESP3Parser(_AsyncRESPBase):
    ...
    async def _read_response(
        ...
        # push response
            ...
            response = await self.handle_push_response(response, disable_decoding, push_request)
            if not push_request:
