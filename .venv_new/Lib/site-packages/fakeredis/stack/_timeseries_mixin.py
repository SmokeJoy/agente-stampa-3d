...
from fakeredis._commands import CommandItem, Float, Int, Key, Timestamp, command
from fakeredis._helpers import OK, Database, SimpleError, SimpleString, casematch
...
class TimeSeriesCommandsMixin:  # TimeSeries commands
    ...
    def _create_timeseries(self, name: bytes, *args) -> TimeSeries:
        (
            ...
            chunk_size,
            duplicate_policy,
            (ignore_max_time_diff, ignore_max_val_diff),
        ...
        return [
            ...
            [
                [
                    ...
                    rule.aggregator.upper(),
                    rule.align_timestamp,
                ]
    ...
    def ts_alter(self, key: CommandItem, *args: bytes) -> bytes:
        ...
        (
            ...
            args,
            ("+retention", "+chunk_size", "*duplicate_policy", "++ignore"),
            error_on_unexpected=False,
        )
    ...
    def ts_mget(self, *args: bytes) -> List[List[Union[bytes, List[List[Union[int, float]]]]]]:
        latest, with_labels, selected_labels, filter_expression = (
            False,
            False,
            None,
            None,
    ...
    def _group_by_label(self, reverse: bool, ts_list: List[Any], label: bytes, reducer: bytes) -> TimeSeries:
        ...
        for label_value, timestamp_values in ts_map.items():
            ...
            labels = {
                label: label_value,
                b"__reducer__": reducer,
                b"__source__": sources,
            }
