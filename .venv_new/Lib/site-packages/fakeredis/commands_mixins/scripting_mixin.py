...
import logging
import os
from typing import Any, AnyStr, Callable, Dict, List, Optional, Set, Tuple

import lupa
from fakeredis import _msgs as msgs
from fakeredis._commands import Int, Signature, command
...
class ScriptingCommandsMixin:
    ...
    def _lua_redis_call(
        self,
        lua_runtime: LUA_MODULE.LuaRuntime,
